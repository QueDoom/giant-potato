...
import net.quedoom.giant_potato.block.entity.renderer.CrusherBlockEntityRenderer;
...
public class GiantPotatoClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        BlockEntityRenderers.register(ModBlockEntities.CRUSHER_BE, CrusherBlockEntityRenderer::new);
