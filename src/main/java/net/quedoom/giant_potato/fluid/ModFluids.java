package net.quedoom.giant_potato.fluid;
...
import net.quedoom.giant_potato.fluid.fluid.MashFluid;
import net.quedoom.giant_potato.fluid.fluid.PoisonousMashFluid;
import net.quedoom.giant_potato.fluid.fluid.SewerWaterFluid;
import net.quedoom.giant_potato.fluid.item.MashBucketItem;
