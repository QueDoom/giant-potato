 ...
 * Use {@link ContainerHelper#saveAllItems(CompoundTag, NonNullList, HolderLookup.Provider)} and
 * {@link ContainerHelper#loadAllItems(CompoundTag, NonNullList, HolderLookup.Provider)}
...
public interface ImplementedInventory extends WorldlyContainer {
    ...
    default boolean canPlaceItemThroughFace(int slot, ItemStack stack, @Nullable Direction side) {
        ...
        if (ItemStack.isSameItemSameComponents(stackNormalized, itemStackNormalized) && i <= j) {
